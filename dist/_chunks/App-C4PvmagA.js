...
const ActionsContainer$1 = styled.styled(designSystem.Flex)`
...
const createStepComponents = (tourName) => ({
  ...
  Actions: ({ showStepCount = true, showPrevious = true, showSkip = false, to, children, ...flexProps }) => {
    return /* @__PURE__ */ jsxRuntime.jsx(ActionsContainer$1, {
      width: "100%",
      padding: 3,
      paddingLeft: 5,
...
const ChatWindowWrapper = styled__default.default(designSystem.Box)`
  position: fixed;
  bottom: 100px;
  right: 24px;
  width: 380px;
...
`;
const FloatingButton = styled__default.default.button`
  position: fixed;
  bottom: 24px;
  right: 24px;
  width: 64px;
...
const BasicSettings = ({
  ...
  const [hovered, setHovered] = React__namespace.default.useState(null);
...
`;
const ActionsContainer = styled__default.default(designSystem.Flex)`
  opacity: 0.6;
...
`;
const StyledAccordionItem = styled__default.default(designSystem.Accordion.Item)`
  margin: 0 !important;
  padding: 0 !important;
...
`;
const HeaderRow = styled__default.default(designSystem.Flex)`
  width: 100%;
  min-height: 65px;
  padding-right: 24px;
  padding-left: 24px;
...
`;
const StyledTrigger = styled__default.default(designSystem.Accordion.Trigger)`
  flex: 1;
...
`;
const StyledHeader = styled__default.default(designSystem.Accordion.Header)`
...
const VerticalDivider = styled__default.default.div`
  ...
  margin: 0 4px;
`;
const CardStyleButton = styled__default.default.button`
  padding: 4px 16px;
  border-radius: 8px;
  border: 1px solid
...
const EmptyStateWrapper = styled__default.default(designSystem.Flex)`
  ...
  background: ${({ theme }) => theme.colors.neutral0};
`;
const InfoCircle = styled__default.default.div`
  width: 32px;
  height: 32px;
  border-radius: 50%;
  background: ${({ theme }) => theme.colors.neutral100};
  ...
  margin-bottom: 16px;
`;
const AddButtonWrapper = styled__default.default(designSystem.Box)`
  padding: 12px 24px;
  background: ${({ theme }) => theme.colors.neutral0};
`;
...
`;
const AddActionRow = styled__default.default(designSystem.Flex)`
  padding: 16px 24px;
  gap: 12px;
  background: ${({ theme }) => theme.colors.neutral0};
  margin-top: 4px;
`;
const InlineSelect = styled__default.default.select`
  flex: 1;
...
const ResponseTemplates = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    isAdding ? /* @__PURE__ */ jsxRuntime.jsxs(AddActionRow, { alignItems: "center", children: [
      /* @__PURE__ */ jsxRuntime.jsxs(InlineSelect, { value: selectedUid, onChange: (e2) => setSelectedUid(e2.target.value), children: [
        /* @__PURE__ */ jsxRuntime.jsx("option", { value: "", children: "Select a collection type..." }),
        availableCollections.map((ac) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: ac.uid, children: ac.name }, ac.uid))
      ] }),
      ...
      GhostAddButton,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(icons.Plus, { width: 12 }),
          " Add collection"
        ]
      }
    ) })
...
const AiInstructions = ({
  ...
  const theme = styled.useTheme();
  const [localResponse, setLocalResponse] = React.useState(() => getCleanText(responseInstructions));
...
const ZapIcon = ({ width = 15, height = 15, color }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "svg",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z" })
    }
  );
};
...
const ProgressBar = styled__default.default.div`
  ...
  border-radius: 999px;
`;
const StatusTag = styled__default.default.div`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 4px 10px;
...
const Container = styled__default.default(designSystem.Box)`
  ...
  width: 100%;
`;
const LockBadge = styled__default.default.div`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 4px 10px;
...
`;
const BlurOverlay = styled__default.default.div`
  position: absolute;
  inset: 0;
  z-index: 5;
...
`;
const LockCircle = styled__default.default.div`
  width: 36px;
  height: 36px;
  border-radius: 50%;
...
`;
const HeaderBox = styled__default.default(designSystem.Box)`
...
const LockedSection = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Container, { marginBottom: 6, children: [
    /* @__PURE__ */ jsxRuntime.jsx(HeaderBox, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", alignItems: "center", children: [
      ...
      isLocked && /* @__PURE__ */ jsxRuntime.jsxs(LockBadge, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(icons.Lock, { width: 11 }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Complete Basic Settings to unlock" })
      ] })
    ] }) }),
...
const HomePage = () => {
  ...
  const [responseInstructions, setResponseInstructions] = React.useState("");
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ChatbotPreview, {})
  ] });
};
const App = () => {

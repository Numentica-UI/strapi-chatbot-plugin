...
import { Flex, Box, Popover, Typography, Button, LinkButton, Link, Portal, Alert, Field, SubNav, Badge, TextInput, Checkbox, Accordion, Loader, Main } from "@strapi/design-system";
import { WarningCircle, CaretDown, ChevronDown, Message, ArrowClockwise, Cross, PaperPlane, Eye, EyeStriked, Check, Pencil, Paragraph, Trash, Information, Plus, Drag, CheckCircle, CrossCircle, Lock } from "@strapi/icons";
import "react-dom/client";
import ReactDOM, { unstable_batchedUpdates as unstable_batchedUpdates$1 } from "react-dom";
import "@strapi/icons/symbols";
import styled$1, { styled, createGlobalStyle, useTheme } from "styled-components";
...
var isFunction$6 = isFunction_1, isMasked = _isMasked, isObject$e = isObject_1, toSource$1 = _toSource;
var reRegExpChar = /[\\^$.*+?()[\]{}|]/g;
...
var isFunction$5 = isFunction_1, isLength$2 = isLength_1;
...
var isPlainObject_1 = isPlainObject$9;
...
var assignMergeValue$1 = _assignMergeValue, cloneBuffer$1 = _cloneBufferExports, cloneTypedArray$1 = _cloneTypedArray, copyArray$3 = _copyArray, initCloneObject$1 = _initCloneObject, isArguments$2 = isArguments_1, isArray$f = isArray_1, isArrayLikeObject = isArrayLikeObject_1, isBuffer$4 = isBufferExports, isFunction$4 = isFunction_1, isObject$b = isObject_1, isPlainObject$8 = isPlainObject_1, isTypedArray$2 = isTypedArray_1, safeGet$1 = _safeGet, toPlainObject = toPlainObject_1;
function baseMergeDeep$1(object2, source, key, srcIndex, mergeFunc, customizer, stack) {
  ...
  if (isCommon) {
    ...
    } else if (isPlainObject$8(srcValue) || isArguments$2(srcValue)) {
      newValue = objValue;
      if (isArguments$2(objValue)) {
        newValue = toPlainObject(objValue);
      } else if (!isObject$b(objValue) || isFunction$4(objValue)) {
...
var stringToPath$4 = memoizeCapped(function(string2) {
  var result = [];
...
var isArray$c = isArray_1, isKey$3 = _isKey, stringToPath$3 = _stringToPath, toString$7 = toString_1;
function castPath$6(value, object2) {
  if (isArray$c(value)) {
    return value;
  }
  return isKey$3(value, object2) ? [value] : stringToPath$3(toString$7(value));
}
...
function baseSet$1(object2, path, value, customizer) {
  ...
  while (nested != null && ++index < length) {
    ...
    if (index != lastIndex) {
      ...
      if (newValue === void 0) {
        newValue = isObject$8(objValue) ? objValue : isIndex$2(path[index + 1]) ? [] : {};
      }
    }
...
var baseGet$4 = _baseGet, baseSet = _baseSet, castPath$3 = _castPath;
function basePickBy$1(object2, paths, predicate) {
  var index = -1, length = paths.length, result = {};
  while (++index < length) {
    var path = paths[index], value = baseGet$4(object2, path);
...
var isPlainObject$5 = isPlainObject$6;
function copyWithStructuralSharing(oldObj, newObj) {
  if (oldObj === newObj || !(isPlainObject$5(oldObj) && isPlainObject$5(newObj) || Array.isArray(oldObj) && Array.isArray(newObj))) {
    return newObj;
  }
...
var defaultSerializeQueryArgs$1 = function(_j) {
  ...
  if (typeof cached === "string") {
    ...
    var stringified = JSON.stringify(queryArgs, function(key, value) {
      return isPlainObject$6(value) ? Object.keys(value).sort().reduce(function(acc, key2) {
        acc[key2] = value[key2];
        return acc;
      }, {}) : value;
    });
...
var useIsomorphicLayoutEffect$1 = typeof window !== "undefined" && !!window.document && !!window.document.createElement ? useLayoutEffect : useEffect;
...
curry.placeholder = {};
var curry_1 = curry;
var baseGetTag = _baseGetTag, isObjectLike$2 = isObjectLike_1, isPlainObject$4 = isPlainObject_1;
...
function isError$1(value) {
  ...
  return tag == errorTag$1 || tag == domExcTag || typeof value.message == "string" && typeof value.name == "string" && !isPlainObject$4(value);
}
...
var get_1 = get$3;
var baseIsEqual = _baseIsEqual, get$2 = get_1, hasIn = hasIn_1, isKey$2 = _isKey, isStrictComparable = _isStrictComparable, matchesStrictComparable = _matchesStrictComparable, toKey$3 = _toKey;
...
var baseProperty = _baseProperty, basePropertyDeep = _basePropertyDeep, isKey$1 = _isKey, toKey$2 = _toKey;
function property$1(path) {
  return isKey$1(path) ? baseProperty(toKey$2(path)) : basePropertyDeep(path);
}
...
var rearg_1 = rearg;
var arrayMap$1 = _arrayMap, copyArray = _copyArray, isArray$5 = isArray_1, isSymbol$1 = isSymbol_1, stringToPath$2 = _stringToPath, toKey$1 = _toKey, toString$6 = toString_1;
function toPath(value) {
  if (isArray$5(value)) {
    return arrayMap$1(value, toKey$1);
  }
  return isSymbol$1(value) ? [value] : copyArray(stringToPath$2(toString$6(value)));
}
var toPath_1 = toPath;
var _util = {
  "ary": ary_1,
...
var sentinel = {};
var stringify$1 = function stringify(object2, prefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, encoder, filter2, sort, allowDots, serializeDate2, format, formatter, encodeValuesOnly, charset, sideChannel2) {
  var obj = object2;
...
const getFetchClient = (defaultOptions2 = {}) => {
  const backendURL = window.strapi.backendURL;
    ...
    get: async (url, options) => {
      ...
      const executeRequest = async () => {
        ...
        const response = await fetch(createRequestUrl(url), {
          signal: options?.signal ?? defaultOptions2.signal,
          method: "GET",
          headers
        });
...
function createContext(rootComponentName, defaultContext) {
  const Context2 = E(defaultContext);
...
const isEmptyObject$1 = (val) => {
  if (!isObject$3(val) || isBuffer2(val)) {
    return false;
  }
  try {
...
const ActionsContainer$1 = styled(Flex)`
...
const createStepComponents = (tourName) => ({
  ...
  Actions: ({ showStepCount = true, showPrevious = true, showSkip = false, to, children, ...flexProps }) => {
    return /* @__PURE__ */ jsx(ActionsContainer$1, {
      width: "100%",
      padding: 3,
      paddingLeft: 5,
...
var get = (object2, path, defaultValue) => {
  ...
  const result = (isKey(path) ? [path] : stringToPath2(path)).reduce((result2, key) => isNullOrUndefined(result2) ? result2 : result2[key], object2);
...
var validateField = async (field, disabledFieldNames, formValues, validateAllFieldCriteria, shouldUseNativeValidation, isFieldArray) => {
  const { ref: ref2, refs, required, maxLength, minLength, min: min2, max: max2, pattern, validate, name, valueAsNumber, mount } = field._f;
...
function createFormControl(props = {}) {
  ...
  const _getFieldArray = (name) => compact2(get(_state.mount ? _formValues : _defaultValues, name, _options.shouldUnregister ? get(_defaultValues, name, []) : []));
...
const ChatWindowWrapper = styled$1(Box)`
  position: fixed;
  bottom: 100px;
  right: 24px;
  width: 380px;
...
`;
const FloatingButton = styled$1.button`
  position: fixed;
  bottom: 24px;
  right: 24px;
  width: 64px;
...
`;
const ChatLayout = styled$1(Flex)`
  height: 100%;
`;
const IconButton = styled$1(Box).attrs({ as: "button" })`
  background: none;
  border: none;
  cursor: pointer;
  display: flex;
`;
const MessagesArea = styled$1(Box)`
  flex: 1;
  overflow-y: auto;
`;
const MessageBubble = styled$1(Box)`
...
`;
const InputBar = styled$1(Box)`
  border-top: 1px solid #f0f0f5;
`;
const InputGrow = styled$1(Box)`
  flex-grow: 1;
`;
const SendButton = styled$1(Button)`
  height: 40px;
`;
const ChatbotPreview = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(FloatingButton, { onClick: () => setIsOpen(!isOpen), title: "Toggle Chatbot Preview", children: isOpen ? /* @__PURE__ */ jsx(ChevronDown, { width: 24, height: 24 }) : /* @__PURE__ */ jsx(Message, { width: 28, height: 28 }) }),
    /* @__PURE__ */ jsx(ChatWindowWrapper, { $isOpen: isOpen, background: "neutral0", hasRadius: true, children: /* @__PURE__ */ jsxs(ChatLayout, { direction: "column", alignItems: "stretch", children: [
      /* @__PURE__ */ jsx(Box, { padding: 4, background: "primary600", children: /* @__PURE__ */ jsxs(Flex, { justifyContent: "space-between", alignItems: "center", children: [
        /* @__PURE__ */ jsxs(Flex, { gap: 2, children: [
          ...
          /* @__PURE__ */ jsx(IconButton, { onClick: handleClearHistory, title: "Clear History", children: /* @__PURE__ */ jsx(ArrowClockwise, { color: "neutral0", width: 14 }) })
        ] }),
        /* @__PURE__ */ jsx(IconButton, { onClick: () => setIsOpen(false), title: "Close Chat", children: /* @__PURE__ */ jsx(Cross, { color: "neutral0", width: 14 }) })
      ] }) }),
      /* @__PURE__ */ jsx(MessagesArea, { ref: scrollRef, padding: 4, background: "neutral100", children: /* @__PURE__ */ jsx(Flex, { direction: "column", alignItems: "stretch", gap: 3, children: messages.map((msg, idx) => /* @__PURE__ */ jsx(
        MessageBubble,
        {
          padding: 3,
          hasRadius: true,
      ...
      /* @__PURE__ */ jsx(InputBar, { padding: 3, background: "neutral0", children: /* @__PURE__ */ jsxs(Flex, { gap: 2, alignItems: "center", children: [
        /* @__PURE__ */ jsx(InputGrow, { children: /* @__PURE__ */ jsx(
          TextInput,
          {
            placeholder: "Type a message...",
            ...register("message"),
            onKeyDown: (e2) => e2.key === "Enter" && handleSubmit(onSend)()
          }
        ) }),
        /* @__PURE__ */ jsx(
          SendButton,
...
const HeaderTitle = styled$1(Typography)`
  ...
  margin: 0;
`;
const HeaderDesc = styled$1(Typography)`
  font-size: 12px;
  margin-top: 3px;
  line-height: 1.5;
  margin-bottom: 0;
`;
const RowBox = styled$1(Box)`
  display: flex;
  gap: 16px;
  padding: 16px 24px;
...
`;
const LeftCol = styled$1(Box)`
  width: 168px;
  flex-shrink: 0;
`;
const RowTitle = styled$1(Typography)`
  font-size: 13px;
  display: block;
  margin-bottom: 2px;
`;
const RowDesc = styled$1(Typography)`
  line-height: 1.4;
  font-size: 11px;
`;
const RightCol = styled$1(Box)`
  flex: 1;
`;
const EditColumn = styled$1(Box)`
  display: flex;
  flex-direction: column;
  gap: 8px;
`;
const InputRow = styled$1(Box)`
  display: flex;
  align-items: center;
  gap: 12px;
`;
const InputWrapper = styled$1(Box)`
  display: flex;
  align-items: center;
  width: 100%;
  max-width: 360px;
...
const StyledInput = styled$1.input`
  ...
  background: transparent;
`;
const EyeButton = styled$1.button`
  padding-right: 12px;
  background: none;
  border: none;
  cursor: pointer;
  ...
  align-items: center;
`;
const SaveButton$1 = styled$1.button`
  padding: 6px 12px;
  border-radius: 8px;
  background: ${({ theme }) => theme.colors.primary600};
  ...
  white-space: nowrap;
`;
const CancelButton$1 = styled$1.button`
  padding: 6px 12px;
  border-radius: 8px;
  border: 1px solid ${({ theme }) => theme.colors.neutral200};
  background: transparent;
...
const ErrorBox = styled$1(Box)`
  ...
  max-width: 480px;
`;
const ErrorText = styled$1(Typography)`
  font-size: 12px;
`;
const ViewColumn = styled$1(Box)`
  display: flex;
  flex-direction: column;
  gap: 8px;
`;
const ViewRow = styled$1(Box)`
  display: flex;
  align-items: center;
  gap: 12px;
`;
const ValueText = styled$1(Typography)`
  font-size: 13px;
  max-width: 320px;
  overflow: hidden;
  ...
  white-space: nowrap;
`;
const NotConfiguredBadge = styled$1(Box)`
  padding: 2px 10px;
  border-radius: 999px;
  background: ${({ theme }) => theme.colors.danger100};
`;
const NotConfiguredText = styled$1(Typography)`
  font-size: 11px;
  letter-spacing: 0.04em;
`;
const SavedIndicator = styled$1(Box)`
  display: flex;
  align-items: center;
  gap: 6px;
`;
const SavedText = styled$1(Typography)`
  font-size: 12px;
  font-weight: 500;
`;
const EditButton = styled$1.button`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 4px 10px;
...
`;
const TokenPillsRow = styled$1(Box)`
  display: flex;
  gap: 8px;
  flex-wrap: wrap;
`;
const TokenPill = styled$1(Box)`
  display: flex;
  align-items: center;
  gap: 6px;
  ...
  padding: 5px 10px;
`;
const TokenIconBox = styled$1(Box)`
  width: 18px;
  height: 18px;
  border-radius: 4px;
  background: ${({ $bg }) => $bg};
  ...
  flex-shrink: 0;
`;
const TokenLabel = styled$1(Typography)`
  font-size: 11px;
  font-weight: 500;
  white-space: nowrap;
`;
const TokenDivider = styled$1(Box)`
  width: 1px;
  height: 14px;
  background: ${({ theme }) => theme.colors.secondary100};
`;
const TokenValue = styled$1(Typography)`
  font-size: 12px;
  font-weight: 700;
  white-space: nowrap;
`;
const SettingRow = ({
  ...
  const [isSaved, setIsSaved] = React__default.useState(false);
  const [isHovered, setIsHovered] = React__default.useState(false);
  const [showKey, setShowKey] = React__default.useState(false);
  const {
    register,
    handleSubmit,
    reset,
  ...
  const onSave = async ({ fieldValue }) => {
    if (type2 === "key" && fieldValue.trim()) {
      try {
  ...
  return /* @__PURE__ */ jsxs(
    RowBox,
    {
      ...
      $isLast: isLast,
      children: [
        /* @__PURE__ */ jsxs(LeftCol, { children: [
          /* @__PURE__ */ jsx(RowTitle, { variant: "omega", fontWeight: "600", textColor: "neutral800", children: title }),
          /* @__PURE__ */ jsx(RowDesc, { variant: "pi", textColor: "neutral500", children: description })
        ] }),
        /* @__PURE__ */ jsx(RightCol, { children: isEditing ? /* @__PURE__ */ jsxs(EditColumn, { children: [
          /* @__PURE__ */ jsxs(InputRow, { children: [
            /* @__PURE__ */ jsxs(InputWrapper, { $hasError: !!errors.fieldValue, children: [
              /* @__PURE__ */ jsx(
                StyledInput,
                {
                  autoFocus: true,
                  ...
                  ...register("fieldValue"),
                  onKeyDown: (e2) => e2.key === "Enter" && handleSubmit(onSave)()
                }
              ),
              type2 === "key" && /* @__PURE__ */ jsx(EyeButton, { type: "button", onClick: () => setShowKey(!showKey), children: showKey ? /* @__PURE__ */ jsx(Eye, { width: 16, height: 16 }) : /* @__PURE__ */ jsx(EyeStriked, { width: 16, height: 16 }) })
            ] }),
            /* @__PURE__ */ jsx(
              SaveButton$1,
              {
                ...
                children: isSubmitting ? "Validating..." : "Save"
              }
            ),
            /* @__PURE__ */ jsx(CancelButton$1, { type: "button", onClick: handleCancel, children: "Cancel" })
          ] }),
          errors.fieldValue && type2 === "key" && /* @__PURE__ */ jsx(ErrorBox, { children: /* @__PURE__ */ jsx(ErrorText, { variant: "pi", textColor: "danger600", children: errors.fieldValue.message }) })
        ] }) : /* @__PURE__ */ jsxs(ViewColumn, { children: [
          /* @__PURE__ */ jsxs(ViewRow, { children: [
            value ? /* @__PURE__ */ jsx(
              ValueText,
              {
                variant: "omega",
            ...
            ) : /* @__PURE__ */ jsx(NotConfiguredBadge, { children: /* @__PURE__ */ jsx(NotConfiguredText, { variant: "pi", textColor: "danger600", fontWeight: "600", children: "NOT CONFIGURED" }) }),
            isSaved && /* @__PURE__ */ jsxs(SavedIndicator, { children: [
              /* @__PURE__ */ jsx(Check, { width: 12, height: 12 }),
              /* @__PURE__ */ jsx(SavedText, { variant: "pi", textColor: "success600", children: "Saved" })
            ] }),
            /* @__PURE__ */ jsxs(
              EditButton,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(Pencil, { width: 11, height: 11 }),
                  value ? "Edit" : "Add"
                ]
              }
            )
          ] }),
          type2 === "key" && value && tokenUsage && /* @__PURE__ */ jsxs(TokenPillsRow, { children: [
            /* @__PURE__ */ jsxs(TokenPill, { children: [
              /* @__PURE__ */ jsx(TokenIconBox, { $bg: "secondary100", children: /* @__PURE__ */ jsx(Paragraph, { width: 11, height: 11, fill: "primary600" }) }),
              /* @__PURE__ */ jsx(TokenLabel, { variant: "pi", textColor: "neutral500", children: "Tokens Used" }),
              /* @__PURE__ */ jsx(TokenDivider, {}),
              /* @__PURE__ */ jsx(TokenValue, { variant: "pi", textColor: "neutral800", children: tokenUsage.tokensUsed.toLocaleString() })
            ] }),
            /* @__PURE__ */ jsxs(TokenPill, { children: [
              /* @__PURE__ */ jsx(TokenIconBox, { $bg: "success100", children: /* @__PURE__ */ jsx(WarningCircle, { width: 11, height: 11, fill: "success600" }) }),
              /* @__PURE__ */ jsx(TokenLabel, { variant: "pi", textColor: "neutral500", children: "Est. Cost" }),
              /* @__PURE__ */ jsx(TokenDivider, {}),
              /* @__PURE__ */ jsxs(TokenValue, { variant: "pi", textColor: "neutral800", children: [
                "$",
...
const BasicSettings = ({
  ...
  const [tokenUsage, setTokenUsage] = React__default.useState(void 0);
  React__default.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxs(Wrapper, { children: [
    /* @__PURE__ */ jsx(Header, { children: /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(HeaderTitle, { as: "h2", textColor: "neutral800", children: "Basic Settings" }),
      /* @__PURE__ */ jsx(HeaderDesc, { as: "p", textColor: "neutral600", children: "Core identity and access configuration for your chatbot." })
    ] }) }),
    /* @__PURE__ */ jsx(
      SettingRow,
      {
...
const CustomText = styled$1.span`
  font-weight: ${({ weight }) => weight || 400};
  font-size: ${({ size }) => size || "13px"};
  line-height: ${({ lh }) => lh || "normal"};
  color: ${({ color, theme }) => color ? theme.colors[color] || color : theme.colors.neutral800};
`;
const ActionsContainer = styled$1(Flex)`
  opacity: 0.6;
...
`;
const StyledAccordionItem = styled$1(Accordion.Item)`
  margin: 0 !important;
  padding: 0 !important;
...
`;
const StyledTrigger = styled$1(Accordion.Trigger)`
  flex: 1;
...
const SectionTitle$1 = styled$1(Typography)`
  ...
  display: block;
`;
const VerticalDivider = styled$1.div`
  width: 1px;
  height: 14px;
  background: ${({ theme }) => theme.colors.neutral200};
  margin: 0 4px;
`;
const CardStyleButton = styled$1.button`
  padding: 4px 16px;
  border-radius: 8px;
  border: 1px solid
...
`;
const ActionButton = styled$1.button`
  width: 28px;
  height: 28px;
  display: flex;
  align-items: center;
...
`;
const EmptyStateWrapper = styled$1(Flex)`
  padding: 48px 24px;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
const InfoCircle = styled$1.div`
  ...
  margin-bottom: 16px;
`;
const AddButtonWrapper = styled$1(Box)`
  padding: 12px 24px;
  background: ${({ theme }) => theme.colors.neutral0};
`;
const GhostAddButton$1 = styled$1.button`
  background: transparent;
  border: none;
  display: flex;
  align-items: center;
...
`;
const AddActionRow = styled$1(Flex)`
  padding: 16px 24px;
  gap: 12px;
  background: ${({ theme }) => theme.colors.neutral0};
  margin-top: 4px;
`;
const InlineSelect = styled$1.select`
  flex: 1;
...
`;
const SubmitButton = styled$1.button`
  background: ${({ theme }) => theme.colors.primary600};
  color: ${({ theme }) => theme.colors.neutral0};
  padding: 8px 16px;
  border-radius: 8px;
...
`;
const CancelButton = styled$1.button`
  background: ${({ theme }) => theme.colors.neutral0};
  border: 1px solid ${({ theme }) => theme.colors.neutral200};
  padding: 8px 16px;
  border-radius: 8px;
...
`;
const AccordionRoot = styled$1(Accordion.Root)`
  border: none;
  box-shadow: none;
`;
const AccordionContent = styled$1(Accordion.Content)`
  border: none;
`;
const FieldsRow = styled$1(Flex)`
  gap: 16px;
  flex-wrap: wrap;
  margin-bottom: 24px;
  align-items: center;
`;
const FieldItem = styled$1(Flex)`
  gap: 8px;
  align-items: center;
  min-height: 1.5rem;
`;
const CardStyleRow = styled$1(Flex)`
  gap: 8px;
`;
const ResponseTemplates = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(AccordionRoot, { value: openItem, onValueChange: setOpenItem, children: collections.map((c2) => {
      ...
      return /* @__PURE__ */ jsxs(StyledAccordionItem, { value: c2.uid, children: [
        /* @__PURE__ */ jsx(StyledHeader, { $isOpen: isOpen, style: { border: "none" }, children: /* @__PURE__ */ jsxs(HeaderRow, { alignItems: "center", children: [
          /* @__PURE__ */ jsx(StyledTrigger, { children: /* @__PURE__ */ jsxs(Box, { children: [
            /* @__PURE__ */ jsx(
              CustomText,
              {
                weight: 600,
          ...
          /* @__PURE__ */ jsx(ActionsContainer, { children: /* @__PURE__ */ jsx(
            ActionButton,
            {
              type: "button",
              onClick: (e2) => {
              ...
              children: /* @__PURE__ */ jsx(Trash, { width: "13", height: "13" })
            }
          ) })
        ] }) }),
        /* @__PURE__ */ jsx(AccordionContent, { children: /* @__PURE__ */ jsxs(Box, { padding: 6, background: "transparent", children: [
          /* @__PURE__ */ jsx(SectionTitle$1, { children: "FIELDS" }),
          /* @__PURE__ */ jsxs(FieldsRow, { children: [
            /* @__PURE__ */ jsxs(Flex, { gap: 2, alignItems: "center", children: [
              ...
              /* @__PURE__ */ jsx(CustomText, { size: "13px", weight: 500, children: "All" })
            ] }),
            /* @__PURE__ */ jsx(VerticalDivider, {}),
            c2.fields.map((f2) => /* @__PURE__ */ jsxs(FieldItem, { children: [
              /* @__PURE__ */ jsx(
                Checkbox,
                {
                  checked: f2.enabled,
              ...
              /* @__PURE__ */ jsx(CustomText, { size: "13px", children: f2.name })
            ] }, f2.name))
          ] }),
          /* @__PURE__ */ jsx(SectionTitle$1, { children: "CARD STYLE" }),
          /* @__PURE__ */ jsxs(CardStyleRow, { children: [
            /* @__PURE__ */ jsx(
              CardStyleButton,
              {
                type: "button",
            ...
            cardOptions.map((opt) => /* @__PURE__ */ jsx(
              CardStyleButton,
              {
                type: "button",
    ...
    collections.length === 0 && !isAdding && /* @__PURE__ */ jsxs(EmptyStateWrapper, { children: [
      /* @__PURE__ */ jsx(InfoCircle, { children: /* @__PURE__ */ jsx(Information, { width: 18, height: 18 }) }),
      /* @__PURE__ */ jsx(CustomText, { size: "13px", color: "neutral600", children: "No collections yet. Add one to get started." })
    ] }),
    isAdding ? /* @__PURE__ */ jsxs(AddActionRow, { alignItems: "center", children: [
      /* @__PURE__ */ jsxs(InlineSelect, { ...register("selectedUid"), children: [
        /* @__PURE__ */ jsx("option", { value: "", children: "Select a collection type..." }),
        availableCollections.map((ac) => /* @__PURE__ */ jsx("option", { value: ac.uid, children: ac.name }, ac.uid))
      ] }),
      /* @__PURE__ */ jsx(SubmitButton, { type: "button", onClick: handleSubmit(onSubmitAdd), children: "Add" }),
      /* @__PURE__ */ jsx(CancelButton, { type: "button", onClick: handleCancel, children: "Cancel" })
    ] }) : availableCollections.length > 0 && /* @__PURE__ */ jsx(AddButtonWrapper, { children: /* @__PURE__ */ jsxs(
      GhostAddButton$1,
      {
        type: "button",
        onClick: () => {
...
const EmptyState = styled$1(Box)`
  ...
  text-align: center;
`;
const QuestionRow = styled$1(Flex)`
  border-bottom: 1px solid ${({ theme }) => theme.colors.neutral150};
...
`;
const NumberBadge = styled$1(Box)`
  width: 20px;
  height: 20px;
  border-radius: 50%;
  background: ${({ theme }) => theme.colors.secondary100};
  ...
  color: ${({ theme }) => theme.colors.primary600};
`;
const EditInput = styled$1.input`
  flex: 1;
  padding: 8px 12px;
  border-radius: 8px;
  border: 1.5px solid ${({ theme }) => theme.colors.primary600};
...
`;
const EditFlex = styled$1(Flex)`
  flex: 1;
`;
const SaveEditButton = styled$1(Button)`
  padding: 6px 12px;
  border-radius: 8px;
  background: ${({ theme }) => theme.colors.primary600};
  color: ${({ theme }) => theme.colors.neutral0};
  ...
  font-size: 12px;
`;
const CancelEditButton = styled$1(Button)`
  padding: 6px 12px;
  border-radius: 8px;
  border: 1px solid ${({ theme }) => theme.colors.neutral200};
  background: transparent;
...
`;
const QuestionText = styled$1(Box)`
  flex: 1;
`;
const ActionIcons = styled$1(Flex)`
  opacity: ${({ $visible }) => $visible ? 1 : 0};
  pointer-events: ${({ $visible }) => $visible ? "auto" : "none"};
  transition: opacity 0.2s;
`;
const IconBtn = styled$1.button`
  width: 28px;
  height: 28px;
  display: flex;
  align-items: center;
  ...
  cursor: pointer;
`;
const EditIconBtn = styled$1(IconBtn)`
  color: ${({ theme }) => theme.colors.neutral600};
  &:hover {
    background: ${({ theme }) => theme.colors.primary100};
  }
`;
const TrashIconBtn = styled$1(IconBtn)`
  color: ${({ theme }) => theme.colors.danger600};
  &:hover {
    background: ${({ theme }) => theme.colors.danger100};
  }
`;
const AddInputRow = styled$1(Flex)`
  padding: 16px 24px;
`;
const AddInput = styled$1.input`
  ...
  box-shadow: 0 0 0 3px ${({ theme }) => theme.colors.primary100};
`;
const AddButtonRow = styled$1(Box)`
  padding-top: 12px;
  padding-bottom: 12px;
  padding-left: 24px;
  padding-right: 24px;
  background: ${({ theme }) => theme.colors.neutral0};
`;
const GhostAddButton = styled$1.button`
  background: transparent;
  border: none;
  display: flex;
  align-items: center;
...
const SuggestedQuestions = ({
  ...
  const onSubmitEdit = (index) => ({ value }) => {
    if (value.trim()) onEdit(index, value);
    setEditingIndex(null);
    reset({ value: "" });
  };
  const handleDragStart = (e2, index) => {
    setDraggedIndex(index);
    e2.dataTransfer.effectAllowed = "move";
  };
  const handleDragOver = (e2, index) => {
    e2.preventDefault();
  ...
  return /* @__PURE__ */ jsxs(Box, { children: [
    questions.length === 0 && !isAdding && /* @__PURE__ */ jsx(EmptyState, { textAlign: "center", children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral600", style: { fontSize: "13px" }, children: "No suggested questions yet." }) }),
    questions.map((q2, index) => /* @__PURE__ */ jsxs(
      QuestionRow,
      {
        alignItems: "center",
        ...
        children: [
          /* @__PURE__ */ jsx(DragHandle, { children: /* @__PURE__ */ jsx(Drag, {}) }),
          /* @__PURE__ */ jsx(NumberBadge, { children: index + 1 }),
          editingIndex === index ? /* @__PURE__ */ jsxs(EditFlex, { gap: 2, children: [
            /* @__PURE__ */ jsx(
              EditInput,
              {
                autoFocus: true,
                ...register("value"),
                onKeyDown: (e2) => e2.key === "Enter" && handleSubmit(onSubmitEdit(index))()
              }
            ),
            /* @__PURE__ */ jsx(SaveEditButton, { onClick: handleSubmit(onSubmitEdit(index)), children: "Save" }),
            /* @__PURE__ */ jsx(CancelEditButton, { onClick: () => {
              setEditingIndex(null);
              reset();
            }, children: "Cancel" })
          ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(QuestionText, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", style: { fontSize: "13px" }, children: q2 }) }),
            /* @__PURE__ */ jsxs(ActionIcons, { gap: 1, $visible: hoveredIndex === index, children: [
              /* @__PURE__ */ jsx(EditIconBtn, { type: "button", onClick: () => handleStartEdit(index, q2), children: /* @__PURE__ */ jsx(Pencil, { width: "13", height: "13" }) }),
              /* @__PURE__ */ jsx(TrashIconBtn, { type: "button", onClick: () => onRemove(index), children: /* @__PURE__ */ jsx(Trash, { width: "13", height: "13" }) })
            ] })
          ] })
        ]
      },
    ...
    isAdding ? /* @__PURE__ */ jsxs(AddInputRow, { paddingLeft: 6, paddingRight: 6, paddingTop: 4, paddingBottom: 4, gap: 3, children: [
      /* @__PURE__ */ jsx(
        AddInput,
        {
          autoFocus: true,
          ...
          ...register("value"),
          onKeyDown: (e2) => e2.key === "Enter" && handleSubmit(onSubmitAdd)()
        }
      ),
      /* @__PURE__ */ jsx(SaveEditButton, { onClick: handleSubmit(onSubmitAdd), children: "Add" }),
      /* @__PURE__ */ jsx(CancelEditButton, { onClick: () => {
        setIsAdding(false);
        reset();
      }, children: "Cancel" })
    ] }) : /* @__PURE__ */ jsx(AddButtonRow, { children: /* @__PURE__ */ jsxs(GhostAddButton, { type: "button", onClick: handleStartAdd, children: [
      /* @__PURE__ */ jsx(Plus, { width: 12, height: 12 }),
      "Add question"
    ] }) })
  ] });
};
...
const Container$1 = styled$1(Box)`
  padding: 16px 24px 20px;
`;
const SectionBlock = styled$1(Box)`
  margin-bottom: 20px;
`;
const LabelRow = styled$1(Box)`
  display: flex;
  align-items: center;
  gap: 6px;
  margin-bottom: 6px;
...
const Label = styled$1.span`
  ...
  color: ${({ theme }) => theme.colors.neutral800};
`;
const HelpText = styled$1.p`
  font-size: 11px;
  color: ${({ theme }) => theme.colors.neutral500};
  margin-bottom: 8px;
`;
const TextAreaWrapper = styled$1(Box)`
...
`;
const StyledTextarea = styled$1.textarea`
  width: 100%;
  min-height: 120px;
  padding: 10px 12px;
  border: none;
  ...
  background: transparent;
`;
const ToneSection = styled$1(Box)`
  margin-top: 20px;
  padding-top: 16px;
  border-top: 1px solid ${({ theme }) => theme.colors.neutral150};
`;
const ToneSectionTitle = styled$1.div`
  font-size: 12px;
  font-weight: 600;
  color: ${({ theme }) => theme.colors.neutral800};
  margin-bottom: 6px;
`;
const PillRow = styled$1(Box)`
  display: flex;
  gap: 8px;
  margin-bottom: 8px;
  flex-wrap: wrap;
`;
const TonePill = styled$1.button`
  padding: 6px 12px;
  border-radius: 999px;
  font-size: 12px;
...
const AiInstructions = ({
  ...
  const selectTone = (t2) => {
    const nextTone = tone === t2 ? null : t2;
    setTone(nextTone);
...
${currentContent}` : currentContent;
  ...
  return /* @__PURE__ */ jsxs(Container$1, { children: [
    /* @__PURE__ */ jsxs(SectionBlock, { children: [
      /* @__PURE__ */ jsxs(LabelRow, { children: [
        /* @__PURE__ */ jsx(Label, { children: "System Instructions" }),
        /* @__PURE__ */ jsx(Information, { width: 13, height: 13, fill: theme.colors.neutral500 })
      ] }),
      /* @__PURE__ */ jsx(HelpText, { children: "Each line is a separate instruction. Changes auto-save when you click elsewhere." }),
      /* @__PURE__ */ jsx(TextAreaWrapper, { children: /* @__PURE__ */ jsx(
        StyledTextarea,
        {
...
Don't mention competitor airlines`,
    ...
    /* @__PURE__ */ jsxs(ToneSection, { children: [
      /* @__PURE__ */ jsx(ToneSectionTitle, { children: "Response Tone" }),
      /* @__PURE__ */ jsxs(PillRow, { children: [
        /* @__PURE__ */ jsx(TonePill, { $active: tone === "friendly", type: "button", onClick: () => selectTone("friendly"), children: "Friendly & Warm" }),
        /* @__PURE__ */ jsx(TonePill, { $active: tone === "professional", type: "button", onClick: () => selectTone("professional"), children: "Professional" }),
        /* @__PURE__ */ jsx(TonePill, { $active: tone === "concise", type: "button", onClick: () => selectTone("concise"), children: "Concise" })
      ] }),
      /* @__PURE__ */ jsx(HelpText, { children: "Customize the AI response message. Changes auto-save when you click elsewhere." }),
      /* @__PURE__ */ jsx(TextAreaWrapper, { children: /* @__PURE__ */ jsx(
        StyledTextarea,
        {
...
const ZapIcon = ({ width = 15, height = 15, color }) => {
  ...
  return /* @__PURE__ */ jsx(
    "svg",
    {
      ...
      children: /* @__PURE__ */ jsx("path", { d: "M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z" })
    }
  );
};
const ProgressContainer = styled$1(Box)`
  border-radius: 12px;
  border: 1px solid ${({ theme }) => theme.colors.neutral200};
  background: ${({ theme }) => theme.colors.neutral0};
  margin-bottom: 24px;
  overflow: hidden;
`;
const ProgressBarWrapper = styled$1.div`
  width: 100%;
  height: 6px;
  background: ${({ theme }) => theme.colors.secondary100};
  border-radius: 999px;
  overflow: hidden;
`;
const ProgressBar = styled$1.div`
  height: 100%;
  width: ${({ percent }) => percent}%;
  background: ${({ isFull, theme }) => isFull ? `linear-gradient(90deg, ${theme.colors.success600}, ${theme.colors.success200})` : `linear-gradient(90deg, ${theme.colors.primary600}, ${theme.colors.primary500})`};
  transition: width 0.5s ease-in-out;
  border-radius: 999px;
`;
const StatusTag = styled$1.div`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 4px 10px;
...
`;
const CountBadge = styled$1.span`
  ...
  font-weight: 700;
`;
const TitleRow = styled$1(Flex)`
  gap: 8px;
  align-items: center;
`;
const TitleText = styled$1(Typography)`
  font-size: 14px;
`;
const SubText = styled$1(Typography)`
  font-size: 12px;
  margin-top: 4px;
  display: block;
`;
const TagsRow = styled$1(Flex)`
  gap: 8px;
  flex-wrap: wrap;
  margin-top: 16px;
`;
const SetupProgress = ({
  ...
  const completedCount = tasks.filter((t2) => t2.done).length;
  const isFull = completedCount === tasks.length;
  const percentage = completedCount / tasks.length * 100;
  return /* @__PURE__ */ jsx(ProgressContainer, { children: /* @__PURE__ */ jsxs(Box, { padding: 6, children: [
    /* @__PURE__ */ jsxs(Flex, { justifyContent: "space-between", alignItems: "flex-start", marginBottom: 3, children: [
      /* @__PURE__ */ jsxs(Box, { children: [
        /* @__PURE__ */ jsxs(TitleRow, { children: [
          /* @__PURE__ */ jsx(ZapIcon, {}),
          /* @__PURE__ */ jsx(TitleText, { variant: "delta", fontWeight: "bold", textColor: "neutral800", children: "Setup Progress" })
        ] }),
        /* @__PURE__ */ jsx(SubText, { variant: "pi", textColor: "neutral600", children: isFull ? "🎉 Your chatbot is fully configured and ready to go!" : "Configure your AI chatbot's identity, data, and behaviour." })
      ] }),
      /* @__PURE__ */ jsxs(CountBadge, { isFull, children: [
        completedCount,
        "/",
        tasks.length
      ] })
    ] }),
    /* @__PURE__ */ jsx(ProgressBarWrapper, { children: /* @__PURE__ */ jsx(ProgressBar, { percent: percentage, isFull }) }),
    /* @__PURE__ */ jsx(TagsRow, { children: tasks.map((task, i2) => /* @__PURE__ */ jsxs(StatusTag, { active: task.done, children: [
      task.done ? /* @__PURE__ */ jsx(CheckCircle, {}) : /* @__PURE__ */ jsx(CrossCircle, {}),
      task.label
    ] }, i2)) })
  ] }) });
};
const Container = styled$1(Box)`
  border-radius: 14px;
  border: 1px solid ${({ theme }) => theme.colors.neutral200};
  background: ${({ theme }) => theme.colors.neutral0};
  overflow: hidden;
...
`;
const BlurOverlay = styled$1.div`
  position: absolute;
  inset: 0;
  z-index: 5;
  display: flex;
...
`;
const HeaderBox = styled$1(Box)`
  padding: 16px 24px 18px 24px;
  border-bottom: 1px solid ${({ theme }) => theme.colors.neutral200};
`;
const SectionTitle = styled$1(Typography)`
  font-size: 14px;
`;
const SectionDesc = styled$1(Typography)`
  font-size: 12px;
  margin-top: 4px;
  display: block;
`;
const ContentArea = styled$1(Box)`
  opacity: ${({ $isLocked }) => $isLocked ? 0.35 : 1};
  pointer-events: ${({ $isLocked }) => $isLocked ? "none" : "auto"};
`;
const OverlayText = styled$1(Typography)`
  font-size: 13px;
  text-align: center;
`;
const BoldInline = styled$1(Typography)`
  font-size: 13px;
`;
const LockedSection = ({ title, description, isLocked, children }) => {
  return /* @__PURE__ */ jsxs(Container, { marginBottom: 6, children: [
    /* @__PURE__ */ jsx(HeaderBox, { children: /* @__PURE__ */ jsxs(Flex, { justifyContent: "space-between", alignItems: "center", children: [
      /* @__PURE__ */ jsxs(Box, { children: [
        /* @__PURE__ */ jsx(
          SectionTitle,
          {
      ...
      isLocked && /* @__PURE__ */ jsxs(LockBadge, { children: [
        /* @__PURE__ */ jsx(Lock, { width: 11 }),
        /* @__PURE__ */ jsx("span", { children: "Complete Basic Settings to unlock" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs(Box, { position: "relative", children: [
      isLocked && /* @__PURE__ */ jsx(BlurOverlay, { children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "center", gap: 2, children: [
        /* @__PURE__ */ jsx(LockCircle, { children: /* @__PURE__ */ jsx(Lock, { width: 16 }) }),
        /* @__PURE__ */ jsxs(OverlayText, { variant: "omega", textColor: "neutral600", children: [
          "Fill in",
          " ",
          /* @__PURE__ */ jsx(BoldInline, { fontWeight: "bold", textColor: "neutral800", children: "Base Domain" }),
          ",",
          " ",
          /* @__PURE__ */ jsx(BoldInline, { fontWeight: "bold", textColor: "neutral800", children: "OpenAI API Key" }),
          " ",
          "and",
          " ",
          /* @__PURE__ */ jsx(BoldInline, { fontWeight: "bold", textColor: "neutral800", children: "Contact Link" }),
          " ",
          "first."
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(ContentArea, { $isLocked: isLocked, children })
    ] })
  ] });
};
...
const LoaderWrapper = styled$1(Flex)`
  height: 100vh;
`;
const UnsavedBar = styled$1(Box)`
  width: 100%;
  height: 50px;
  display: flex;
  align-items: center;
  ...
  z-index: 6;
`;
const UnsavedText = styled$1(Typography)`
  font-weight: 500;
  font-size: 13px;
  line-height: 19.5px;
`;
const DiscardButton = styled$1.button`
  background: none;
  border: none;
  cursor: pointer;
  font-family: Inter;
  ...
  color: inherit;
`;
const SaveAllButton = styled$1(Button)`
  width: 87.84px;
  height: 28px;
  border-radius: 10px;
  border: none;
  ...
  padding: 0;
`;
const StickyHeader = styled$1(Box)`
  top: ${({ $hasUnsaved }) => $hasUnsaved ? "50px" : "0"};
`;
const CenteredBox = styled$1(Box)`
  max-width: 704px;
  margin: 0 auto;
  width: 100%;
`;
const PageTitle = styled$1(Typography)`
  font-weight: 700;
  font-size: 20px;
  line-height: 30px;
  display: block;
`;
const PageSubtitle = styled$1(Typography)`
  font-weight: 400;
  font-size: 13px;
  line-height: 19.5px;
`;
const SavedBadge = styled$1(Box)`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 0 14px;
  ...
  border-radius: 8px;
`;
const SavedBadgeText = styled$1(Typography)`
  font-size: 13px;
  font-weight: 500;
  font-family: Inter, sans-serif;
`;
const SaveButton = styled$1(Button)`
  border: none;
  color: white;
  font-size: 13px;
  padding: 7px 14px;
...
const HomePage = () => {
  ...
  const {
    ...
    setValue,
    handleSubmit,
    formState: { isDirty: isDirty2, isSubmitting }
  } = useForm({
    defaultValues: {
      openaiKey: "",
      baseDomain: "",
  ...
  const init = async () => {
    try {
      const { data } = await get2("/faq-ai-bot/collections");
      ...
      const formattedAll = (data.contentTypes || []).map((ct) => ({
        uid: ct.uid,
        name: ct.displayName,
        cardStyle: savedStyles[ct.uid] || void 0,
        fields: ct.attributes.filter((attr) => !SYSTEM_FIELDS.includes(attr.name)).map((attr) => ({
          name: attr.name,
          enabled: savedConfig[ct.uid]?.includes(attr.name) || false
        }))
      }));
      setAllContentTypes(formattedAll);
      const initialActive = formattedAll.filter(
        (ct) => Object.keys(savedConfig).includes(ct.uid)
      );
  ...
  const onSubmit = async (data) => {
    try {
      ...
      data.activeCollections.forEach((item) => {
        const enabled = item.fields.filter((f2) => f2.enabled).map((f2) => f2.name);
  ...
  if (isLoading)
    return /* @__PURE__ */ jsx(LoaderWrapper, { justifyContent: "center", children: /* @__PURE__ */ jsx(Loader, {}) });
  return /* @__PURE__ */ jsxs(Main, { children: [
    isDirty2 && /* @__PURE__ */ jsxs(UnsavedBar, { background: "warning100", borderColor: "warning200", children: [
      /* @__PURE__ */ jsxs(Flex, { alignItems: "center", gap: 2, children: [
        /* @__PURE__ */ jsx(Information, { color: "warning600", width: 18, height: 18 }),
        /* @__PURE__ */ jsx(UnsavedText, { textColor: "warning600", children: "You have unsaved changes" })
      ] }),
      /* @__PURE__ */ jsxs(Flex, { gap: 4, children: [
        /* @__PURE__ */ jsx(DiscardButton, { onClick: () => reset(), children: "Discard" }),
        /* @__PURE__ */ jsx(
          SaveAllButton,
          {
            ...
            children: isSubmitting ? "Saving..." : "Save All"
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsx(
      StickyHeader,
      {
        ...
        paddingBottom: 4,
        $hasUnsaved: isDirty2,
        children: /* @__PURE__ */ jsx(CenteredBox, { children: /* @__PURE__ */ jsxs(Flex, { justifyContent: "space-between", alignItems: "baseline", children: [
          /* @__PURE__ */ jsxs(Box, { children: [
            /* @__PURE__ */ jsx(PageTitle, { textColor: "neutral800", children: "Chatbot Configuration" }),
            /* @__PURE__ */ jsx(Box, { paddingTop: 1, children: /* @__PURE__ */ jsx(PageSubtitle, { textColor: "neutral600", children: "Configure your AI chatbot's identity, data, and behaviour." }) })
          ] }),
          /* @__PURE__ */ jsx(Flex, { alignItems: "center", children: isSaved ? /* @__PURE__ */ jsxs(SavedBadge, { background: "success100", children: [
            /* @__PURE__ */ jsx(Check, { width: 14, height: 14, color: "success600" }),
            /* @__PURE__ */ jsx(SavedBadgeText, { textColor: "success600", children: "Saved!" })
          ] }) : !isDirty2 && /* @__PURE__ */ jsx(
            SaveButton,
            {
              onClick: handleSubmit(onSubmit),
              startIcon: /* @__PURE__ */ jsx(Check, { width: 14, height: 14 }),
              background: "primary600",
              disabled: isSubmitting,
    ...
    /* @__PURE__ */ jsx(Box, { background: "neutral100", paddingTop: 6, paddingBottom: 8, marginBottom: 8, children: /* @__PURE__ */ jsxs(CenteredBox, { children: [
      /* @__PURE__ */ jsx(
        SetupProgress,
        {
      ...
      /* @__PURE__ */ jsx(
        BasicSettings,
        {
          ...
          savedOpenaiKey,
          contactLink: values.contactLink,
          onManage: (type2, value = "") => {
            if (type2 === "key") setValue("openaiKey", value, { shouldDirty: true });
            if (type2 === "domain") setValue("baseDomain", value, { shouldDirty: true });
            if (type2 === "contact") setValue("contactLink", value, { shouldDirty: true });
          }
        }
      ),
      /* @__PURE__ */ jsx(
          ...
          children: /* @__PURE__ */ jsx(
            ResponseTemplates,
            {
              ...
              availableCollections: allContentTypes.filter(
                (c2) => c2.uid !== "plugin::faq-ai-bot.faqqa" && !values.activeCollections.some((active) => active.uid === c2.uid)
              ),
              cardOptions,
              onToggleField: (uid, fName) => {
                const updated = values.activeCollections.map(
                  (c2) => c2.uid !== uid ? c2 : {
                    ...c2,
              ...
              onRemoveCollection: (uid) => {
                setValue(
                  "activeCollections",
                  values.activeCollections.filter((c2) => c2.uid !== uid),
                  { shouldDirty: true }
                );
              },
      ...
      /* @__PURE__ */ jsx(
        LockedSection,
        {
          ...
          children: /* @__PURE__ */ jsx(
            ...
            {
              questions: values.suggestedQuestions,
              onAdd: (val) => setValue("suggestedQuestions", [...values.suggestedQuestions, val], { shouldDirty: true }),
              onEdit: (index, val) => {
                const updated = [...values.suggestedQuestions];
                updated[index] = val;
                setValue("suggestedQuestions", updated, { shouldDirty: true });
              },
              onRemove: (index) => setValue(
                "suggestedQuestions",
                values.suggestedQuestions.filter((_2, i2) => i2 !== index),
                { shouldDirty: true }
              ),
              onReorder: (newQuestions) => setValue("suggestedQuestions", [...newQuestions], { shouldDirty: true })
            }
          )
        }
      ),
